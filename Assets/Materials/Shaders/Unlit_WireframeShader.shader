Shader "Unlit/Unlit_WireframeShader"
{
    Properties
    {
        _MainTex("Texture", 2D) = "white" {}
        _WireframeFrontColour("Wireframe front colour", color) = (0.5, 0.5, 0.5, 0.6)
        _WireframeBackColour("Wireframe back colour", color) = (0.5, 0.5, 0.5, 0)
        _WireframeWidth("Wireframe width threshold", float) = 0.0001
    }
    SubShader
    {
